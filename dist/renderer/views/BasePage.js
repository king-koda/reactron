            ...
            react_2.default.createElement(PageBody_1.PageBody, { left: '0%', top: '15%', height: '85%', borderBottom: 'solid 6px black', id: 'pgbody' },
                react_2.default.createElement(react_1.Flex, { width: '100%', height: '100%', display: 'flex' }, photos && photos?.length >= 0 && (react_2.default.createElement(react_1.Flex, { direction: 'row', width: '100%' },
                    react_2.default.createElement(react_1.Flex, { height: '100%', id: 'focusedImage', width: '70%', direction: 'column' },
                        react_2.default.createElement(react_1.Flex, { height: '65%', justifyContent: 'center', position: 'fixed', right: '30%', width: '70%', padding: '5' },
                            react_2.default.createElement(react_1.Image, { id: 'highestResImage', objectFit: 'contain', src: `data:image/jpg;base64,${focusedImage?.image}` })),
                        react_2.default.createElement(react_1.Flex, { height: '20%', borderTop: 'solid 6px black', width: '70%', top: '80%', direction: 'row', align: 'center', justifyContent: 'space-evenly', position: 'fixed' },
                            react_2.default.createElement(react_1.Flex, { direction: 'column', width: '100%', height: '100%', align: 'center' },
                                react_2.default.createElement(react_1.Flex, { direction: 'row', width: '100%', align: 'center', textAlign: 'center', justifyContent: 'space-evenly', borderBottom: '6px solid black', 
                                    // paddingBottom='4'
                                    fontWeight: 'bold', height: '30%' },
                                    react_2.default.createElement(react_1.Text, { fontSize: '30px' }, "Name"),
                                ...
                                react_2.default.createElement(react_1.Flex, { direction: 'row', width: '100%', align: 'center', justifyContent: 'space-evenly', textAlign: 'center', height: '70%' },
                                    react_2.default.createElement(react_1.Text, { fontSize: '20px' }, focusedImage?.value),
                    ...
                    react_2.default.createElement(react_1.Flex, { id: 'defocused-images', direction: 'column', width: '30%', height: '100%', borderLeft: 'solid 6px black', overflowY: 'scroll' }, photos &&
                        photos?.map((photo, index) => {
