...
const NextFolderIcon = ({ ...rest }) => {
    return (react_2.default.createElement(react_2.default.Fragment, null,
        react_2.default.createElement(react_1.Flex, { display: "block", align: "center", paddingX: "40px" },
            react_2.default.createElement(index_1.BsArrowRightCircleFill, { size: "200px" }),
            react_2.default.createElement(react_1.Text, { fontWeight: "bold", fontSize: "40px" }, "Next Folder"))));
};
