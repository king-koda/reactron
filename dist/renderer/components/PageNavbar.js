...
const PageNavbar = ({ children, ...rest }) => {
    return (react_2.default.createElement(react_1.Flex, { className: "pgnavbar", height: "20%", width: "100%", 
        //top="calc(20%)"
        bgColor: "white", zIndex: 4, fill: "white", position: "fixed", borderBottom: "solid 6px black", borderLeft: "solid 6px black", borderRight: "solid 6px black", borderTop: "solid 6px black", padding: "25px", ...rest }, children));
};
