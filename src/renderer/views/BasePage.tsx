...
const BasePage = ({ children }: FlexProps) => {
  ...
  }, [photos, markedAll, keepHighestResolution, keepHighestSize, sortPhotos]);
      ...
      >
        ...
        >
          ...
          <Flex direction="column" height="100%">
            <Flex direction="row" height="50%" borderLeft="solid 4px darkblue">
              <IconAndTextWithTooltip
                tooltipProps={{
                  id: 'delete-button',
                  label: 'Delete',
